...
""",
        ...
        # add reference section before next action
        user_msgs.append(
            {
                "type": "text", 
                "text": f"""\
...
You will now think step by step and produce your next best action. Reflect on your past actions, any resulting error message, the current state of the page before deciding on your next action and the successful trace provided for reference. 
""",
            }
        )
